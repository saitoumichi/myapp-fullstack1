        ...
        <main className="flex-1 flex">
              ...
              {allCategories.map((cat) => (
                <li key={cat} className="flex items-center">
                  <input
                    ...
                    className="appearance-none h-4 w-4 mr-2 border border-blue-400 bg-gray-200 checked:bg-blue-400 checked:border-blue-400"
                  />
          ...
          <section className="flex-1 p-6">
            ...
            <div className="mt-6 flex justify-center items-center space-x-2 text-sm">
              <button onClick={handlePrevPage} disabled={currentPage === 1}>◀︎</button>
              ...
              <button onClick={handleNextPage} disabled={currentPage === totalPages}>▶︎</button>
            </div>
          </section>
        </main>
      )}
